  ...
  return (
    <header className="text-gray-400 body-font shadow-lg">
      <div className="container mx-auto flex flex-wrap p-2 flex-col md:flex-row items-center">
        ...
        <button className="inline-flex items-center bg-red-700 border-0 py-1 px-3 focus:outline-none hover:bg-blue-700 rounded text-white mt-0 md:ml-0 transition-colors duration-300">
          Youtube
          <svg
            fill="none"
            stroke="currentColor"
